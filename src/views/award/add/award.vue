<template>
    <div class="project">
        ...
        <el-dialog title="选择项目" :visible="dialogVisible" width="90%" :show-close="false">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          sqdx: [
            { required: true, message: '请至少选择一项层次对象', trigger: 'change' }
          ],
        }
      };
    },
