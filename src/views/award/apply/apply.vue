        ...
        <el-card shadow="hover">
            ...
            <el-form inline size="medium" label-width="110px" class="form-inline">
                <el-form-item label="关联项目" class="block">
                    <el-select v-model="apply.projectId" placeholder="请选择" @change="changeProject">
                        <el-option
                ...
                <el-form-item label=" " class="block tag-margin" v-if="awardProjectSelect.xmlbname">
                    ...
                    <el-tag type="info" size="medium">项目起止时间:{{awardProjectSelect.xmkssj.substring(0,10)}} 至 {{awardProjectSelect.xmzzsj.substring(0,10)}}</el-tag>
                </el-form-item>
