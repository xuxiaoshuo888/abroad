    ...
    <div class="work">
        ...
        <el-card shadow="hover">
            ...
            <el-table :data="tableData1" size="medium" border @row-dblclick="rowDblclick1">
                ...
                <el-table-column prop="xmts" label="天数" width="50" show-overflow-tooltip
                                 align="center"></el-table-column>
                <el-table-column prop="xmfzr" label="项目负责人" width="100" show-overflow-tooltip
                                 align="center"></el-table-column>
                <el-table-column prop="xmfzrdh" label="联系电话" width="80" show-overflow-tooltip
                                 align="center"></el-table-column>
            ...
            <div class="more_div">
                <router-link class="work_more" to="/project/list/my">更多>>></router-link>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      getTableData1() {
        ...
        this.$ajax.post('/project/myPage', {roleId: this.role})
            .then(res => {
