    ...
    <div v-if="destory">
        <el-form :disabled="disable" inline size="medium" :model="form" ref="form" label-width="110px"
            ...
            <el-form-item label="经费来源" class="block" prop="jfly">
                ...
                <el-input class="other" v-model="form.jflyqt" v-show="form.jfly==='101002007'||form.jfly==='102002004'"
                          placeholder="输入其他专项具体内容"></el-input>
            </el-form-item>
            ...
            <el-form-item label="项目类别" class="block" prop="xmlbList">
                ...
                <el-input class="other" v-model="form.xmlbqt"
                          v-show="form.xmlbx==='101001001004'||form.xmlbx==='101001002005'||form.xmlbx==='102001001004'||form.xmlbx==='102001002005'"
                          placeholder="输入其他专项具体内容"></el-input>
            </el-form-item>
            ...
            <el-form-item label="项目活动时间" class="block" prop="daterange">
                ...
                <el-input v-model="form.xmts" disabled placeholder="项目天数"
                          style="width: 90px;text-align:center;margin-left: 20px"></el-input>
            </el-form-item>
            <!--非专项专有申请起止时间-->
            <template v-if="row.sfzx==='102'">
                <el-form-item label="申请开始时间">
                    <el-date-picker class="select" v-model="form.xssqkssj" type="date"
                                    value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                </el-form-item>
                <el-form-item label="申请结束时间">
                    <el-date-picker class="select" v-model="form.xssqzzsj" type="date"
                                    value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                </el-form-item>
            </template>
            ...
            <el-form-item label="立项理由" class="block">
                <el-input type="textarea" :autosize="{ minRows: 4}" v-model="form.xmlxly"
                          placeholder="请填写项目立项理由及主要内容（2000字以内）"></el-input>
            </el-form-item>
            <el-form-item label="行程安排" class="block">
                <el-input type="textarea" :autosize="{ minRows: 4}" v-model="form.xmxcap"
                          placeholder="请填写项目行程安排（1000字以内）"></el-input>
            </el-form-item>
            <el-form-item label="资格要求" class="block">
                <el-input type="textarea" :autosize="{ minRows: 4}" v-model="form.xszgyq"
                          placeholder="请填写学生申请本项目的资格要求（1000字以内）"></el-input>
            </el-form-item>
            <el-form-item label="其他说明" class="block">
                <el-input type="textarea" :autosize="{ minRows: 4}" v-model="form.xmqtsm"
                          placeholder="可填写项目的其他说明（1000字以内）"></el-input>
            </el-form-item>
                    ...
                    <el-table-column align="center" width="100">
                        ...
                        <template slot-scope="scope">
                            <el-button
                                    size="mini"
                                    type="text"
                                    @click="handleDelete(scope.$index, form.xmjfysmxlist)">删除
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
            ...
            <el-form-item label="项目材料上传" class="block" v-else>
                <el-table :data="form.fjlist" border class="detailTable">
                    ...
                    <el-table-column prop="url" label="文件地址">
                        <template slot-scope="scope"><a :href="$proxy+$downloadUrl+scope.row.url"
                                                        class="el-icon-download">下载</a></template>
                    </el-table-column>
                </el-table>
            </el-form-item>
            <el-form-item label="审批记录" class="block" v-if="(form.status=='2' || form.status=='8') && row.sfzx == '101'">
                ...
                审核通过 <span v-if="isChanged">学校奖励更改为{{form.xxjlnew}}元/人</span>
            </el-form-item>
